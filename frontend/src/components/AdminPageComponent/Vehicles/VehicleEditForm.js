...
function AdminVehicleEditForm() {
    ...
    useEffect(() => {
        const fetchVehicle = async () => {
            ...
            setError(null);
            try {
                const data = await AdminPageVehicleService.getVehicleById(id);
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            await AdminPageVehicleService.updateVehicle(id, vehicleDto);
            navigate('/vehicles');
        } catch {
...
export default AdminVehicleEditForm;
