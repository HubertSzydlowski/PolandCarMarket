...
function AdminVehicleList() {
    ...
    const models = tempFilters.brand && brandModels[tempFilters.brand] ? brandModels[tempFilters.brand] : [];
    ...
    useEffect(() => {
        const fetchVehicles = async () => {
            ...
            try {
                ...
                const data = await AdminPageVehicleService.getVehicles(params);
                setVehicles(data);
            } catch {
    ...
    return (
        <div>
            ...
            <fieldset style={{ marginBottom: 20 }}>
                ...
                <label>
                    Brand:
                    <select name="brand" value={tempFilters.brand} onChange={handleTempFilterChange}>
                        <option value="">--</option>
