...
import vehiclePhotoService from '../../../services/AdminPageServices/AdminPageVehiclePhotoService';

function AdminVehiclePhotoList() {
    ...
    return (
        <div>
            <h2>Vehicle Photo List (Admin)</h2>
            {photos.map(photo => (
...
export default AdminVehiclePhotoList;
