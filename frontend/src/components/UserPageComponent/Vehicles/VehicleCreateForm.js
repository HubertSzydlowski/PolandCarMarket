...
function UserVehicleCreateForm() {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            await UserPageVehicleService.createVehicle(vehicleDto);
            navigate('/vehicles');
        } catch {
        ...
        <form onSubmit={handleSubmit}>
            ...
            <label>
                ...
                <select name="model" value={form.model} onChange={handleChange} required disabled={!form.brand}>
                    ...
                    {form.brand && brandModels[form.brand].map(model => (
...
export default UserVehicleCreateForm;
