...
import UserPageVehicleService from '../../../services/UserPageServices/UserPageVehicleService';
import { brandModels } from '../../../services/VehicleServices/vehicleService';

function UserVehicleEditForm() {
    const { id } = useParams();
    ...
    useEffect(() => {
        const fetchVehicle = async () => {
            ...
            setError(null);
            try {
                const data = await UserPageVehicleService.getVehicleById(id);
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            await UserPageVehicleService.updateVehicle(id, vehicleDto);
            navigate('/vehicles');
        } catch {
...
export default UserVehicleEditForm;
