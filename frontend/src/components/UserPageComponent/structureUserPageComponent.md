...
| `FavoritesList.js`             | Shows a list of favorite advertisement IDs.             | `getFavorites()`                                                             |
| `AddToFavoritesButton.js`      | Adds an advertisement to favorites.                     | `addToFavorites(advertisementId)`                                            |
| `RemoveFromFavoritesButton.js` | Removes an advertisement from favorites.                | `removeFromFavorites(advertisementId)`                                       |
