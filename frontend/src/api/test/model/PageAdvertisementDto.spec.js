...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.PageAdvertisementDto();
  });
  ...
  describe('PageAdvertisementDto', function() {
    it('should create an instance of PageAdvertisementDto', function() {
      // uncomment below and update the code to test PageAdvertisementDto
      //var instance = new OpenApiDefinition.PageAdvertisementDto();
      //expect(instance).to.be.a(OpenApiDefinition.PageAdvertisementDto);
    });
