...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.VehiclePhotoDto();
  });
  ...
  describe('VehiclePhotoDto', function() {
    it('should create an instance of VehiclePhotoDto', function() {
      // uncomment below and update the code to test VehiclePhotoDto
      //var instance = new OpenApiDefinition.VehiclePhotoDto();
      //expect(instance).to.be.a(OpenApiDefinition.VehiclePhotoDto);
    });
