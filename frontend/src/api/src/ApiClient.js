...
import { refreshToken as refreshTokenRequest } from '../../services/UserServices/authService';
import TokenManager from '../../services/TokenManager';
...
// Funkcja dodająca response "interceptor"
ApiClient.prototype.addResponseInterceptor = function () {
    const originalEnd = superagent.Request.prototype.end;

    if (superagent.Request.prototype._interceptorPatched) return; // zabezpieczenie przed wielokrotnym nadpisaniem

    superagent.Request.prototype.end = function (callback) {
        const request = this;

        originalEnd.call(this, async function handleResponse(err, res) {
            if (res && res.status === 401 && !request._retry) {
                request._retry = true;
                ...
                try {
                    ...
                    request.set('Authorization', 'Bearer ' + newTokens.accessToken);

                    // Ponownie wyślij to samo zapytanie
    ...
    superagent.Request.prototype._interceptorPatched = true;
};
